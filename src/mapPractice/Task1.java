...
public class Task1 {
    public static void main(String[] args) {
        ...
        given map as parameter should be Map<String,Integere>
        this method will find al values from the given map this method  will return if the value is greater than 25
